...
//                                         <img src="assets/images/icons/verify.png" width="120" alt=""/>
//                                     </div>
//                                     <h4 className="mt-5 font-weight-bold">verify email</h4>
//                                     <p className="">Enter your registered email ID to verify the email</p>
//                                     <div className="my-4">
//                                         <label className="form-label">Email id</label>
//                                         <input type="text" className="form-control form-control-lg" placeholder="example@user.com"/>
//                                     </div>
//                                     <div className="d-grid gap-2">
//                                         <button type="button" className="btn btn-light btn-lg">verify</button>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
...
const Page = () => {
  ...
  const onSubmit = async (data: VerifyFormData) => {
    ...
    try {
      // const response = await axios.post<ApiResponse>("/api/verify-code", {
      const response = await axios.post<ApiResponse>(`${APP_BASE_URL}/verify-code`, {
        userName: params?.username,
        code: data.code,
      });
      toast.success(response.data.message);
