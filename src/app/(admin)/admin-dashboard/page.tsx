                    ...
                    <div className="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                        <div className="inner">
                            <div className="app-card-body p-3 p-lg-4">
                                <h3 className="mb-3">Welcome, {session?.user?.userName}!</h3>
                                <h4 className="mb-3">{session?.user?.email}</h4>
                        ...
                        <div className="col-6 col-lg-3">
                            <div className="app-card app-card-stat shadow-sm h-100">
                                <div className="app-card-body p-3 p-lg-4">
                                    ...
                                    <div className="stats-figure">{ecommerceUser}</div>
                        ...
                        <div className="col-6 col-lg-3">
                            <div className="app-card app-card-stat shadow-sm h-100">
                                <div className="app-card-body p-3 p-lg-4">
                                    ...
                                    <div className="stats-figure">{products.length}</div>
                                    <div className="stats-meta">
