...
// 														<div className="d-grid">	<Link href="/checkout-details" className="btn btn-light btn-ecomm"><i className="bx bx-chevron-left"></i>Back to Details</Link>
// 														</div>
// 													</div>
// 													<div className="col-md-6">
// 														<div className="d-grid">	<Link href="/checkout-payment" className="btn btn-white btn-ecomm">Proceed to Payment<i className="bx bx-chevron-right"></i></Link>
// 														</div>
// 													</div>
// 												</div>
// 											</div>
