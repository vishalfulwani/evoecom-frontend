                    ...
                    <div className="col d-flex">
                        <div className="card rounded-0 w-100">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">See all Sunglasses and get 10% off at all Sunglasses</p> <a href=";" className="btn btn-light btn-ecomm">SHOP BY GLASSES</a>
                            </div>
                        </div>
                    ...
                    <div className="col d-flex">
                        <div className="card rounded-0 w-100">
                            ...
                            <div className="card-body text-center mt-5">
                                ...
                                <p className="card-text">Buy Cosmetics products and get 30% off at all Cosmetics</p> <a href=";" className="btn btn-light btn-ecomm">SHOP BY COSMETICS</a>
                            </div>
                        ...
                        <div className="card rounded-0 w-100">
                            ...
                            <div className="card-img-overlay text-center top-20">
                                <div className="border border-white border-3 py-3 bg-dark-3">
                                    ...
                                    <p className="card-text fs-5">On top Fashion Brands</p> <a href=";" className="btn btn-white btn-ecomm">SHOP BY FASHION</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col d-flex">
                        <div className="card rounded-0 w-100">
                            ...
                            <div className="card-body text-center">
                                ...
                                <p className="card-text">On All Electronic</p> <a href=";" className="btn btn-light btn-ecomm">HURRY UP!</a>
                            </div>
                        </div>
                    </div>
                </div>
